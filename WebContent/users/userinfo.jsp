							...
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF">${sessionScope.users.username }<input type="hidden"
										...
										value="${sessionScope.users.usersid }" /> <input type="hidden" name="money" id="money"
										value="${sessionScope.users.money }" /><input type="hidden" name="role" id="role"
										value="${sessionScope.users.role }" /><input type="hidden" name="status" id="status"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input name="birthday" type="text" size="25"
										class="inputBg" id="birthday" readonly="readonly" onclick="laydate()" value="${sessionScope.users.birthday }" />
									</td>
								</tr>
								<tr>
