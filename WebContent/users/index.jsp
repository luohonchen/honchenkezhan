...
<body class="index_page" style="min-width: 1200px;">
	...
	<div class="container" id="idTransformView">
		<ul class="slider" id="idSlider">
			<li><img alt="" src="pic/001.jpg"></li>
			<li><img alt="" src="pic/002.jpg"></li>
			<li><img alt="" src="pic/003.jpg"></li>
			<li><img alt="" src="pic/004.jpg"></li>
		</ul>
	...
	<div class="block clearfix">
		...
		<div id="category_tree">
			<dl class="clearfix" style="margin-top: -455px;">
				<!-- 循环开始 -->
				<c:forEach items="${frontList}" var="bcate" varStatus="status">
					<div class="dt" onMouseOver="sw_nav2(${status.index + 1},1);" onMouseOut="sw_nav2(${status.index + 1},0);">
						<div id="HandleLI2_${status.index + 1}">
							<a class="a" href="index/bcate.action?id=${bcate.bcateid }">${bcate.bcatename } <img
								src="themes/ecmoban_meilishuo/images/biao8.gif">
							</a>
						</div>
						<!-- 循环开始 -->
						<dd id="DisSub2_${status.index + 1}" style="display: none">
		...
		<div class="goodsBox_1">
			...
			<div class="xm-box">
				...
				<div id="show_new_area" class="clearfix">
					<c:forEach items="${newsList}" var="books">
						<div class="goodsItem">
			...
			<c:forEach items="${frontList}" var="cate">
				...
				<div class="xm-box">
					<h4 class="title">
						<span>${cate.bcatename }</span> <a class="more" href="index/bcate.action?id=${cate.bcateid }">更多</a>
					</h4>
