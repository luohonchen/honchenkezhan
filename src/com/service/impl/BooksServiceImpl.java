...
public class BooksServiceImpl implements BooksService {
	...
	public List<Books> getNewBooks() {
		return this.booksDAO.getNewBooks();
	}

	@Override // 继承接口的查询全部
	public List<Books> getHotBooks() {
		return this.booksDAO.getHotBooks();
	}

	@Override // 继承接口的查询全部
	public List<Books> getRecommendBooks() {
		return this.booksDAO.getRecommendBooks();
	}

	@Override // 继承接口的查询全部
	public List<Books> getBooksCate(String bcateid) {
		return this.booksDAO.getBooksCate(bcateid);
	}
